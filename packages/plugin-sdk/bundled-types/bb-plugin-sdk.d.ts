...
declare const disabledModelsSchema: z$1.ZodArray<z$1.ZodObject<{
    providerId: z$1.ZodString;
    model: z$1.ZodString;
}, z$1.core.$strict>>;
type DisabledModels = z$1.infer<typeof disabledModelsSchema>;
 ...
 * the open inbox.
 */
declare const notificationSchema: z$1.ZodObject<{
    id: z$1.ZodString;
    ...
    title: z$1.ZodString;
    body: z$1.ZodNullable<z$1.ZodString>;
    payload: z$1.ZodType<JsonValue$1, unknown, z$1.core.$ZodTypeInternals<JsonValue$1, unknown>>;
    rendererId: z$1.ZodNullable<z$1.ZodString>;
    dedupeKey: z$1.ZodNullable<z$1.ZodString>;
    attention: z$1.ZodBoolean;
    createdAt: z$1.ZodNumber;
    readAt: z$1.ZodNullable<z$1.ZodNumber>;
    dismissedAt: z$1.ZodNullable<z$1.ZodNumber>;
    target: z$1.ZodNullable<z$1.ZodObject<{
        threadId: z$1.ZodString;
...
type Notification = z$1.infer<typeof notificationSchema>;
declare const notificationListStateSchema: z$1.ZodEnum<{
    all: "all";
    open: "open";
}>;
type NotificationListState = z$1.infer<typeof notificationListStateSchema>;
...
declare const threadEventSchema: z$1.ZodPipe<z$1.ZodUnknown, z$1.ZodUnion<readonly [z$1.ZodIntersection<z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    ...
    type: z$1.ZodLiteral<"provider/sessionReplaced">;
    threadId: z$1.ZodString;
    providerThreadId: z$1.ZodString;
    reason: z$1.ZodString;
    contextLost: z$1.ZodBoolean;
}, z$1.core.$strip>, z$1.ZodObject<{
    ...
    type: z$1.ZodLiteral<"system/childSession/lifecycle">;
    threadId: z$1.ZodString;
    childThreadId: z$1.ZodString;
    childKind: z$1.ZodString;
    title: z$1.ZodString;
    providerId: z$1.ZodString;
    ...
    statusReason: z$1.ZodNullable<z$1.ZodString>;
    outputExcerpt: z$1.ZodNullable<z$1.ZodString>;
}, z$1.core.$strip>, z$1.ZodObject<{
...
declare const turnRequestTargetSchema: z$1.ZodDiscriminatedUnion<[z$1.ZodObject<{
    kind: z$1.ZodLiteral<"thread-start">;
}, z$1.core.$strip>, z$1.ZodObject<{
    kind: z$1.ZodLiteral<"new-turn">;
}, z$1.core.$strip>, z$1.ZodObject<{
...
type TurnRequestTarget = z$1.infer<typeof turnRequestTargetSchema>;
...
declare const threadTurnSpanKindSchema: z$1.ZodEnum<{
    message: "message";
    command: "command";
    tool: "tool";
    reasoning: "reasoning";
...
type ThreadTurnSpanKind = z$1.infer<typeof threadTurnSpanKindSchema>;
declare const threadTurnSpanStatusSchema: z$1.ZodNullable<z$1.ZodEnum<{
    pending: "pending";
    completed: "completed";
    failed: "failed";
    interrupted: "interrupted";
}>>;
type ThreadTurnSpanStatus = z$1.infer<typeof threadTurnSpanStatusSchema>;
interface ThreadTurnSpan {
    id: string;
    itemId: string | null;
 ...
 */
declare const threadTurnRecordSchema: z$1.ZodObject<{
    threadId: z$1.ZodString;
    turnId: z$1.ZodString;
    projectId: z$1.ZodString;
    providerId: z$1.ZodString;
    model: z$1.ZodNullable<z$1.ZodString>;
    modelSource: z$1.ZodNullable<z$1.ZodEnum<{
    ...
    isRoot: z$1.ZodBoolean;
    initiator: z$1.ZodNullable<z$1.ZodString>;
    ...
    counts: z$1.ZodObject<{
        ...
        commands: z$1.ZodNumber;
        fileChanges: z$1.ZodNumber;
        delegations: z$1.ZodNumber;
        subagentSpans: z$1.ZodNumber;
        errors: z$1.ZodNumber;
        interrupted: z$1.ZodBoolean;
    }, z$1.core.$strip>;
    usage: z$1.ZodObject<{
        totalTokens: z$1.ZodNullable<z$1.ZodNumber>;
        inputTokens: z$1.ZodNullable<z$1.ZodNumber>;
        cachedInputTokens: z$1.ZodNullable<z$1.ZodNumber>;
        outputTokens: z$1.ZodNullable<z$1.ZodNumber>;
        reasoningOutputTokens: z$1.ZodNullable<z$1.ZodNumber>;
        modelContextWindow: z$1.ZodNullable<z$1.ZodNumber>;
        source: z$1.ZodEnum<{
            none: "none";
            "provider-turn-delta": "provider-turn-delta";
            "provider-last": "provider-last";
        }>;
        costUsd: z$1.ZodNull;
    }, z$1.core.$strip>;
    sourceSeqStart: z$1.ZodNullable<z$1.ZodNumber>;
    sourceSeqEnd: z$1.ZodNullable<z$1.ZodNumber>;
    spans: z$1.ZodArray<z$1.ZodType<ThreadTurnSpan, unknown, z$1.core.$ZodTypeInternals<ThreadTurnSpan, unknown>>>;
    spansTruncated: z$1.ZodBoolean;
}, z$1.core.$strip>;
type ThreadTurnRecord = z$1.infer<typeof threadTurnRecordSchema>;
...
declare const projectWithThreadsResponseSchema: z$1.ZodObject<{
    ...
    threads: z$1.ZodArray<z$1.ZodObject<{
        ...
        childKind: z$1.ZodNullable<z$1.ZodString>;
        supersededByThreadId: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
        visibility: z$1.ZodEnum<{
            visible: "visible";
            hidden: "hidden";
        }>;
        ...
        unreadNotificationCount: z$1.ZodOptional<z$1.ZodNumber>;
 ...
 */
declare const createNotificationRequestSchema: z$1.ZodObject<{
    threadId: z$1.ZodString;
    pluginId: z$1.ZodString;
    category: z$1.ZodEnum<{
        "review-ready": "review-ready";
    ...
    title: z$1.ZodString;
    body: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
    payload: z$1.ZodOptional<z$1.ZodType<JsonValue$1, unknown, z$1.core.$ZodTypeInternals<JsonValue$1, unknown>>>;
    rendererId: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
    dedupeKey: z$1.ZodOptional<z$1.ZodNullable<z$1.ZodString>>;
    attention: z$1.ZodOptional<z$1.ZodBoolean>;
}, z$1.core.$strict>;
type CreateNotificationRequest = z$1.infer<typeof createNotificationRequestSchema>;
declare const notificationListResponseSchema: z$1.ZodObject<{
    notifications: z$1.ZodArray<z$1.ZodObject<{
        id: z$1.ZodString;
        threadId: z$1.ZodString;
        projectId: z$1.ZodString;
        sourceKind: z$1.ZodEnum<{
    ...
    unreadCount: z$1.ZodNumber;
}, z$1.core.$strict>;
type NotificationListResponse = z$1.infer<typeof notificationListResponseSchema>;
declare const notificationOpenResponseSchema: z$1.ZodObject<{
    outcome: z$1.ZodEnum<{
        focused: "focused";
        "no-client": "no-client";
    ...
    threadId: z$1.ZodString;
    redirectedFromThreadId: z$1.ZodNullable<z$1.ZodString>;
    restored: z$1.ZodObject<{
        unhidden: z$1.ZodBoolean;
        unarchived: z$1.ZodBoolean;
    }, z$1.core.$strict>;
}, z$1.core.$strict>;
type NotificationOpenResponse = z$1.infer<typeof notificationOpenResponseSchema>;
...
declare const timelineChildSessionWorkRowSchema: z$1.ZodObject<{
    id: z$1.ZodString;
    threadId: z$1.ZodString;
    turnId: z$1.ZodNullable<z$1.ZodString>;
    sourceSeqStart: z$1.ZodNumber;
    ...
    workKind: z$1.ZodLiteral<"child-session">;
    childThreadId: z$1.ZodString;
    childKind: z$1.ZodString;
    title: z$1.ZodString;
    providerId: z$1.ZodString;
    model: z$1.ZodNullable<z$1.ZodString>;
    childStatus: z$1.ZodEnum<{
        completed: "completed";
        interrupted: "interrupted";
        started: "started";
        running: "running";
...
type TimelineChildSessionWorkRow = z$1.infer<typeof timelineChildSessionWorkRowSchema>;
...
type TimelineWorkRow = TimelineCommandWorkRow | TimelineToolWorkRow | TimelineFileChangeWorkRow | TimelineWebSearchWorkRow | TimelineWebFetchWorkRow | TimelineImageViewWorkRow | TimelineApprovalWorkRow | TimelineQuestionWorkRow | TimelineChildSessionWorkRow | TimelineDelegationWorkRow | TimelineWorkflowWorkRow;
...
declare const createThreadRequestSchema: z$1.ZodObject<{
    ...
    childKind: z$1.ZodOptional<z$1.ZodString>;
    agentConfiguration: z$1.ZodOptional<z$1.ZodObject<{
        tools: z$1.ZodArray<z$1.ZodUnion<readonly [z$1.ZodString, z$1.ZodObject<{
            name: z$1.ZodString;
            parameters: z$1.ZodRecord<z$1.ZodString, z$1.ZodType<JsonValue$1, unknown, z$1.core.$ZodTypeInternals<JsonValue$1, unknown>>>;
        }, z$1.core.$strict>]>>;
...
declare const threadRevealResponseSchema: z$1.ZodObject<{
    thread: z$1.ZodObject<{
        id: z$1.ZodString;
        projectId: z$1.ZodString;
        environmentId: z$1.ZodNullable<z$1.ZodString>;
...
type ThreadRevealResponse = z$1.infer<typeof threadRevealResponseSchema>;
...
declare const threadTurnsQuerySchema: z$1.ZodObject<{
    beforeCompletedAt: z$1.ZodOptional<z$1.ZodString>;
    include: z$1.ZodOptional<z$1.ZodEnum<{
        messages: "messages";
    }>>;
    includeSpans: z$1.ZodOptional<z$1.ZodEnum<{
        true: "true";
        false: "false";
    }>>;
    limit: z$1.ZodOptional<z$1.ZodString>;
...
type ThreadTurnsQuery = z$1.infer<typeof threadTurnsQuerySchema>;
declare const threadTurnsResponseSchema: z$1.ZodObject<{
    turns: z$1.ZodArray<z$1.ZodObject<{
        projectId: z$1.ZodString;
        threadId: z$1.ZodString;
        sourceSeqEnd: z$1.ZodNullable<z$1.ZodNumber>;
        turnId: z$1.ZodString;
        ...
        isRoot: z$1.ZodBoolean;
        spansTruncated: z$1.ZodBoolean;
        messages: z$1.ZodOptional<z$1.ZodArray<z$1.ZodObject<{
            createdAt: z$1.ZodNumber;
            itemId: z$1.ZodString;
            role: z$1.ZodEnum<{
                user: "user";
        ...
        spans: z$1.ZodOptional<z$1.ZodArray<z$1.ZodType<ThreadTurnSpan, unknown, z$1.core.$ZodTypeInternals<ThreadTurnSpan, unknown>>>>;
    }, z$1.core.$strip>>;
}, z$1.core.$strict>;
type ThreadTurnsResponse = z$1.infer<typeof threadTurnsResponseSchema>;
...
interface PluginNotificationBodyView {
    id: string;
    threadId: string;
    projectId: string;
...
interface PluginNotificationBodyProps {
 ...
 * Experimental: see docs/api_to_audit.md.
 */
interface PluginNotificationBodyRegistration {
    id: string;
 ...
 */
interface PluginTranscriptPreludeProps {
    /**
 ...
 */
interface PluginTranscriptPreludeRegistration {
    /** Unique within the plugin; letters, digits, `-`, `_`. */
    id: string;
...
interface PluginAppSlots {
    ...
    experimental_notificationBody(registration: PluginNotificationBodyRegistration): void;
...
interface NotificationCreateArgs extends Omit<CreateNotificationRequest, "pluginId"> {
    /** Filled automatically for plugin-scoped SDK instances. */
    pluginId?: string;
    signal?: AbortSignal;
}
interface NotificationListArgs {
    projectId?: string;
    signal?: AbortSignal;
    state?: NotificationListState;
    threadId?: string;
}
interface NotificationActionArgs {
    notificationId: string;
    signal?: AbortSignal;
}
type NotificationCreateResult = Notification;
type NotificationListResult = NotificationListResponse;
type NotificationReadResult = Notification;
type NotificationDismissResult = Notification;
type NotificationOpenResult = NotificationOpenResponse;
interface NotificationsArea {
...
interface ThreadTurnsArgs extends ThreadTurnsQuery {
    signal?: AbortSignal;
    threadId: string;
}
...
type TurnPreflightTrigger = "user" | "auto-dispatch" | "queued-auto-send" | "history-replacement";
/** Server-owned context presented immediately before one provider turn. */
interface TurnPreflightContext {
    threadId: string;
    projectId: string;
    environmentId: string;
...
type TurnPreflightHandler = (context: TurnPreflightContext) => TurnPreflightDecision | Promise<TurnPreflightDecision>;
/** One normalized provider event, delivered only after durable insertion. */
interface ProviderEventObservation {
    threadId: string;
    environmentId: string | null;
...
type ProviderEventHandler = (observation: ProviderEventObservation) => void | Promise<void>;
type TurnSettledOutcome = "completed" | "failed" | "interrupted" | "delivery-unknown" | "provider-session-lost";
/**
...
type TurnSettledHandler = (signal: TurnSettledSignal) => void | Promise<void>;
type BindingLifecyclePhase = "start" | "resume" | "model-changed" | "session-replaced" | "health-degraded" | "archived" | "crashed";
/** `bindingId` is opaque; BBF-8 derives it without introducing a table. */
interface BindingLifecycleSignal {
    threadId: string;
    bindingId: string;
    providerId: string;
...
type BindingLifecycleHandler = (signal: BindingLifecycleSignal) => void | Promise<void>;
interface PluginRuntime {
    ...
    onProviderEvent(handler: ProviderEventHandler, options?: {
